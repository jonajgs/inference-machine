            ...
            switch ( part ) {
                ...
                case "<negacion/>":
                    ...
                    if ( condition&&!conclution ) {
                        this.get('conditionParts').push(partRule);
                    }
                    if ( conclution&&!condition ) {
                        this.get('conclutionParts').push(partRule);
                    }
                    break;
                case "<conjuncion/>":
                ...
                default:
                    if ( atom ){
                        part = new Atom({ description: part, state: true, objective });
                        if ( condition&&!conclution&&!objective ) {
                            this.get('conditionParts').push(part);
                        }
                        if ( conclution&&!condition ) {
                            this.get('conclutionParts').push(part);
                        }
                    }
                    break;
            }
